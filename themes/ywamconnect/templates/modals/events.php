      ...
      <div class="col-lg-4">
        ...
        <div class="row">
          <label style="display:block" >Time</label>
            <div class="col-lg-4">
             <div class="form-group">
            <select class="form-control" name="time" id="time_event">
            <?php
              $start = 12; 
              for($i=1;$i<=10;$i++): ?>
        ...
        <div class="row">
          <label style="display:block" >Ending Date</label>
            <div class="col-lg-4">
             <div class="form-group">
            <select class="form-control" name="ending_month"  id="ending_month">
              <?php for ($i = 1; $i <= 12; $i++) : 
               $mon = date("F", mktime(0, 0, 0, $i+1, 0, 0, 0));
               ?>
              <option value="<?=$i;?>"><?= $mon;?></option>
          ...
          <div class="col-lg-4">
            <select class="form-control" name="ending_day" id="ending_day">
             <?php for ($i = 1; $i <= 31; $i++) : ?>
                <option value="<?= $i;?>"><?= $i;?></option>
            <?php endfor; ?>
            </select>
          ...
          <div class="col-lg-4">
            <select class="form-control" name="ending_year"  id="ending_year">
              <?php
              $year = date("Y"); 
              for($i=0;$i<3;$i++): ?>
              <option value="<?=$year + $i;?>"><?= $year + $i;?></option>
        ...
        <div class="col-lg-4">
          ...
          <label for="description">Image/Banner:</label>
                <div class="input-group">
                  <input type="text" class="form-control triggerfile" name="image"  id="image" data-trigger="bannerevent">
    ...
    <div class="modal-dialog">
     ...
     <div class="row">
      ...
      <div class="row">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          <button type="button" class="btn btn-info" id="editeventbtn">Save Changes </button>
        </div>
      </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
  </div><!-- /.modal -->
